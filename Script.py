class script(object):   
    ...
    ABOUT_TXT = """✯ 𝙼𝚈 𝙽𝙰𝙼𝙴 : {}
✯ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁 : <a href=https://t.me/gtxprime>@gtxPrime</a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈 : 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴 : 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴 : 𝙼𝙾𝙽𝙶𝙾-𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁 : 𝙰𝙽𝚈𝚆𝙷𝙴𝚁𝙴
✯ 𝙱𝚄𝙸𝙻𝙳 𝚅𝙴𝚁𝚂𝙸𝙾𝙽: Black Sovereign z4.x"""

    SOURCE_TXT = """<b>NOTE:</b>
- 𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙾𝙳𝙴 𝙲𝙻𝙸𝙲𝙺 𝙷𝙴𝚁 👉 :<a href=https://github.com/gtxPrime/Professor>Black Sovereign</a>

<b>DEVS:</b>
- 𝙳𝚎𝚟 1<a href=https://t.me/mr_MKN>@gtxPrime</a>"""
...
<code>/batch https://t.me/zcipher/10 https://t.me/zcipher/20</code>"""
    
    MANUELFILTER_TXT = """Help: <b>Filters</b>

- Filter is the feature were users can set automated replies for a particular keyword and Black Sovereign will respond whenever a keyword is found the message
